...
export const privacy: LegalDoc = {
  ...
  updated: "August 2026",
  intro: [
    `This Privacy Policy explains how ${site.legalName}, which also does business as ${site.formerName} ("Auxilium," "we," "us"), collects, uses, discloses, and protects information in connection with our website, our insurance products and services, and our software offerings, including Auxilium Governance and Auxilium Accreditation (together, the "Services").`,
    `Auxilium is a managing general agent. Some processing described here supports insurance underwriting and servicing on behalf of our carrier partners. By using the Services, you agree to the practices described in this Policy.`,
  ],
  sections: [
    {
      ...
      bullets: [
        ...
        "Platform telemetry, with your authorization, read-only signals about how your organization deploys AI tools (for example, connected Microsoft 365 or Google Workspace metadata) used to report factual observations about your AI use through Auxilium Governance. This is organizational telemetry, not surveillance of individual employees.",
        "Accreditation data, information about a system's authority, controls, and logs submitted for Auxilium Accreditation.",
    ...
    },
    {
      ...
      bullets: [
        ...
        "To evaluate Auxilium Accreditation submissions.",
